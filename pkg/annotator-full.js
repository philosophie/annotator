...
(function() {
  var $, Annotator, Delegator, LinkParser, Range, Util, base64Decode, base64UrlDecode, createDateFromISO8601, findChild, fn, functions, g, getNodeName, getNodePosition, gettext, parseToken, simpleXPathJQuery, simpleXPathPure, _Annotator, _gettext, _i, _j, _len, _len1, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _t,
    __slice = [].slice,
  ...
  Annotator = (function(_super) {
    ...
    Annotator.prototype.symbolList = null;
    ...
    function Annotator(element, options) {
      ...
      this.showSymbolList = __bind(this.showSymbolList, this);
    ...
    Annotator.prototype.showSymbolList = function(location) {};
    ...
    Annotator.prototype.onAdderRightClick = function() {
      return typeof event !== "undefined" && event !== null ? event.preventDefault() : void 0;
    };
  ...
  Annotator.SymbolList = (function(_super) {
    __extends(SymbolList, _super);

    function SymbolList() {
      _ref2 = SymbolList.__super__.constructor.apply(this, arguments);
      return _ref2;
    }

    SymbolList.prototype.html = "<div class=\"annotator-outer annotator-editor\">\n  <form class=\"annotator-widget\">\n    <ul class=\"annotator-listing\"></ul>\n    <div class=\"annotator-controls\">\n      <a href=\"#cancel\" class=\"annotator-cancel\">" + _t('Cancel') + "</a>\n<a href=\"#save\" class=\"annotator-save annotator-focus\">" + _t('Save') + "</a>\n    </div>\n  </form>\n</div>";
  ...
  Annotator.Viewer = (function(_super) {
    ...
    Viewer.prototype.load = function(annotations) {
      var annotation, controller, controls, del, edit, element, field, item, link, links, list, _k, _l, _len2, _len3, _ref3, _ref4;
  ...
  LinkParser = (function() {
    ...
    LinkParser.prototype.get = function(rel, cond) {
      var d, k, keys, match, v, _k, _len2, _ref3, _results;
      if (cond == null) {
        cond = {};
      }
      cond = $.extend({}, cond, {
  ...
  createDateFromISO8601 = function(string) {
    var d, date, offset, regexp, time, _ref4;
  ...
  base64UrlDecode = function(data) {
    ...
    m = data.length % 4;
    if (m !== 0) {
      for (i = _k = 0, _ref4 = 4 - m; 0 <= _ref4 ? _k < _ref4 : _k > _ref4; i = 0 <= _ref4 ? ++_k : --_k) {
        data += '=';
      }
    }
    data = data.replace(/-/g, '+');
  ...
  parseToken = function(token) {
    var head, payload, sig, _ref4;
    _ref4 = token.split('.'), head = _ref4[0], payload = _ref4[1], sig = _ref4[2];
  ...
  Annotator.Plugin.Store = (function(_super) {
    ...
    Store.prototype._onLoadAnnotations = function(data) {
      var a, annotation, annotationMap, newData, _k, _l, _len2, _len3, _ref4;
      if (data == null) {
        data = [];
      }
      annotationMap = {};
    ...
    Store.prototype.dumpAnnotations = function() {
      var ann, _k, _len2, _ref4, _results;
      _ref4 = this.annotations;
      _results = [];
      for (_k = 0, _len2 = _ref4.length; _k < _len2; _k++) {
        ann = _ref4[_k];
  ...
  Annotator.Plugin.AnnotateItPermissions = (function(_super) {
    ...
    function AnnotateItPermissions() {
      ...
      this.updatePermissionsField = __bind(this.updatePermissionsField, this);
      this.addFieldsToAnnotation = __bind(this.addFieldsToAnnotation, this);
      _ref4 = AnnotateItPermissions.__super__.constructor.apply(this, arguments);
      return _ref4;
    }
    ...
    AnnotateItPermissions.prototype.options = {
      ...
      userAuthorize: function(action, annotation, user) {
        var action_field, permissions, _ref5, _ref6, _ref7, _ref8;
        permissions = annotation.permissions || {};
        action_field = permissions[action] || [];
        if (_ref5 = this.groups.world, __indexOf.call(action_field, _ref5) >= 0) {
          return true;
          ...
          if (user.userId === annotation.user && user.consumerKey === annotation.consumer) {
            return true;
          } else if (_ref6 = this.groups.authenticated, __indexOf.call(action_field, _ref6) >= 0) {
            return true;
          } else if (user.consumerKey === annotation.consumer && (_ref7 = this.groups.consumer, __indexOf.call(action_field, _ref7) >= 0)) {
            return true;
          } else if (user.consumerKey === annotation.consumer && (_ref8 = user.userId, __indexOf.call(action_field, _ref8) >= 0)) {
            return true;
  ...
  Annotator.Plugin.Filter = (function(_super) {
    ...
    Filter.prototype.pluginInit = function() {
      var filter, _k, _len2, _ref5;
      _ref5 = this.options.filters;
      for (_k = 0, _len2 = _ref5.length; _k < _len2; _k++) {
        filter = _ref5[_k];
    ...
    Filter.prototype.updateFilter = function(filter) {
      var annotation, annotations, input, property, _k, _len2, _ref5;
      filter.annotations = [];
      this.updateHighlights();
    ...
    Filter.prototype.filterHighlights = function() {
      var activeFilters, annotation, annotations, filtered, highlights, index, uniques, _k, _len2, _ref5;
      activeFilters = $.grep(this.filters, function(filter) {
        return !!filter.annotations.length;
      });
      filtered = ((_ref5 = activeFilters[0]) != null ? _ref5.annotations : void 0) || [];
  ...
  Annotator.Plugin.Tags = (function(_super) {
    ...
    function Tags() {
      ...
      _ref5 = Tags.__super__.constructor.apply(this, arguments);
      return _ref5;
    }
